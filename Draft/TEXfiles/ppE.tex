...
General relativity (GR) is one of the cornerstones of modern physics, and so far the most  succesful theory of gravitation. Along with the elegant mathematical strucutre and solid conceptual foundation, GR has passed every test with enormous accuracy \cite{Will:2014kxa}. However, there are theoretical and observational motivations which lead to the demand of a modified or alternative theory of gravitation. From theoretical pont of view, GR is a purely classical theory and incompatible with quantum mechanics. Strong gravitational fields at Planck scale where quantum effect cannot be ignored \cite{Adler:2010wf,Ng:2003jk}, such as black holes and very early universe, require a consistent theory of quantum gravity for complete description. Puzzling experimental observations such as accelerated expansion of the universe \cite{Abbott:1988nx,Copeland:2006wr,Perlmutter:1998np,Riess:1998cb,Riess:2004nr,RevModPhys.61.1,vanAlbada:1984js,WEINBERG201387} and anomalous kinematics of the galaxies \cite{article,Bosma:1981zz,Begeman:1991iy,Rubin:1970zza,Rubin:1980zd,1973ApJ...186..467O,Ostriker:1993fr} also suggest that GR might not be capable of explaining every cosmological scenario.

%2.Previous tests of gravity
Tests of gravity before gravitational wave era included solar system experiments, observations of radio pulsars, and cosmological observations. All of them cover different ranges of length scale and regime. Solar system experiments constrain gravity in weak field and slow motion environment, or in terms of relativistic equations of motion, they can give access only to first order corrections to Newtonian dynamics \cite{Berti:2015itd,Will:2014kxa}. Pulsar timing observations significantly improve upon solar system constraints, and probe gravity in a specific sector of strong-field which is dynamical but quasi-linear \cite{Freire:2012mg,Kramer:2006nb,Liu:2011ae,Ransom:2014xla,Stairs:2002cw,Stairs:1997kz,Stairs:2003eg,taylor1992experimental,Wex:2014nva,Yunes:2013dva}. Cosmological observations constrain gravity in weak field regime but at length scales which are many orders of magnitude larger compared to other tests \cite{Berti:2015itd,Clifton:2011jh,Jain:2010ka,Joyce:2014kja,Koyama:2015vza}. Cosmological tests of gravity include observations of cosmic microwave background radiation (CMB) \cite{0004-637X-737-2-98,Akrami:2018odb,Ade:2015xua,Salvatelli:2016mgy,Ade:2015xua,Bennett:2012zja,Hinshaw:2012aka}, study of big bang nucleosynthesis (BBN) \cite{Clifton:2005xr,Coc:2006rt,Damour:1998ae,Komatsu:2010fb,Mathews:2017xht,Olive:1999ij,PhysRevD.56.7627}, weak gravitational lensing \cite{Abbott:2005bi,Bartelmann:1999yn,Collett:2018gpf,Clowe:2006eq,Huterer2010,Lewis:2006fu}, and observations of galaxies \cite{Berti:2015itd} and stellar orbit around galactic center \cite{Ghez:2003qj,Hees:2017aal}. Some studies suggest that combining different probes can give better constraint on gravity from cosmological observations \cite{Weinberg:2012es}.\st{We can remove the details about cosmological observations and merge this paragraph with the next one if you want.The paragraph was very big so I split it into two paragraphs.}

%How GW observation is different, recent GW events.
Compared to other tests of gravity, GW observations are advantageous in several ways. GWs provide the opportunity to probe gravity in strong-field regimes, they can travel from the source to the detector almost without disruption, and allow access to the nonluminous sources such as binary black holes \cite{Yunes:2013dva}. All modified theories of gravitation reduce to GR in weak-field limit, which makes it reasonable to search for the evidences of such theories in nondynamical strong fields. GWs emitted from binary stellar and black hole mergers are the most promising tools for that purpose. Until now six individual GW signals have been detected, five of them are from binary black holes \cite{Abbott:2016blz,Abbott:2016nmj,Abbott:2017vtc,Abbott:2017gyy,Abbott:2017oio} and one is from binary neutron stars \cite{TheLIGOScientific:2017qsa}. Analysis of the events GW150914 \cite{Abbott:2016blz} and GW151226 \cite{Abbott:2016nmj} placed constriants on several mechanisms associated with alternative theories of gravity \cite{Yunes:2016jcc}. Recently, constraints on the models of dark energy have been calculated from GW170817 as well \cite{Battye:2018ssx,Ezquiaga:2018btd}. \st{The last ref. is just an arXiv version. We can remove it if you want.}




%3 propagation and generation, different polarization modes.


%4.ppE framework (explain current bounds on ppE parameters from existing GW events like GW150915 and GW151226)



%5.Executive summary and table
