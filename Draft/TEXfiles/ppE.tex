...
\begin{abstract} 
\ky{Let's try not to use acronyms in the abstract.}
...
\ky{We need to explain what PPE formalism is and motivations behind it, so I added the following few sentences.}
...
\ky{There is not much point and listing non-GR theories that we study in this paper since many of the readers will have no idea what they are. It'd be better to list what fundamental pillars in GR they break, as I did here.}
...
We also correct some of the errors in previous literature.  
%
%Results
%%New results
...
The expressions in dCS and noncommutative gravity only applies to binary BHs, while those in other theories apply to any compact binaries (last column)\footnote{Practically speaking, the expression for dCS is also valid for BH/NS binaries, if one sets on the of the spins to zero.}.
