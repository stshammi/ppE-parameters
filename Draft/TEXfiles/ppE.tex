...
with $a=4$, and
 ...
 \end{align}
with $b=-1$. Here $\chi_{s,a}=(\chi_1 \pm \chi_2 )/2$ \ky{I've simplified the expression for $\chi_s$ and $\chi_a$. Although we don't explicitly say in my paper with Nico and Frans, the above $\beta$ expression is only valid for spin-aligned binaries.} are the symmetric and antisymmetric combinations of dimensionless spin parameters 
...
\ky{I've created this new paragraph.}
