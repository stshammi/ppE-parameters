...
\hline
\noalign{\smallskip}
\multirow{2}{*}{Theories}&\multicolumn{2}{c}{PPE Corrections to GW Phase}\\ \cline{2-3}
& Magnitude ($\beta$)   & Exponent ($b$)  \\ \hline
 %Theories&Magnitude Correction,$\beta$ & Exponent Correction,$b$\\ \hline
Scalar-Tensor Theories & $-\frac{5}{7168}\eta ^{2/5}(\alpha_1-\alpha_2)^2$&-7\\ \hline
EdGB Gravity&$-\frac{5}{7168}\zeta_\EDGB\frac{(m_1^2\tilde s_2^\EDGB-m_2^2\tilde s_1^\EDGB)^2}{m^4\eta^{18/5}}$&-7\\ \hline
dCS Gravity& $\frac{1549225}{11812864}\eta ^{-14/5} \zeta_{\DCS} \left[-2 \delta_m \chi_a \chi_s+\left(1-\frac{16068 \eta }{61969}\right)\chi_a^2 +\left(1-\frac{231808 \eta }{61969}\right)\chi_s^2\right]
$ &-1\\ \hline
Einstein-\AE ther Theory& $-\frac{5}{3584}\eta ^{2/5} (s_1^\EA-s_2^\EA)^2\frac{(c_{14}-2) w_0^3-w_1^3}{c_{14} w_0^3 w_1^3 [(1-s_1^\EA) (1-s_2^\EA)]^{4/3}}$  & -7\\ \hline
Khronometric Theory&$-\frac{5}{96} \eta ^{2/5}\sqrt{\bar \alpha_{\KG}}\frac{(s_1^\KG-s_2^\KG)^2}{[(1-s_1^\KG) (1-s_2^\KG)]^{4/3}} \left[\frac{(\bar \beta_{\KG}-1)(2+\bar \beta_{\KG}+3\bar \lambda_{\KG})}{(\bar \alpha_{\KG}-2)(\bar \beta_{\KG}+\bar \lambda_{\KG})}\right]^{3/2}$&-7\\ \hline 
Noncommutative Gravity & $-\frac{75}{256}\eta ^{-4/5}(2 \eta -1) \Lambda ^2$ &-1\\ \hline
Varying-G Theories&$-\frac{75 \mathcal{M}_0}{851968 {G_0}^{10/3}}\left(\frac{11 \dot{G}_0}{3 G_0}+ \frac{17 \dot{m}_0}{3m_0}- \frac{m_{1,0}\dot{m}_{2,0}+\dot{m}_{1,0}m_{2,0}}{{m_0}^2 \eta0}\right)$& -13\\ 
\noalign{\smallskip}
\hline
\hline
\end{tabular}
\end{centering}
\caption{PPE corrections to GW phase in various modified theories of gravity.}
...
\hline
\noalign{\smallskip}
\multirow{2}{*}{Theories}&\multicolumn{2}{c}{PPE Corrections to GW Amplitude}\\ \cline{2-3}
& Magnitude ($\alpha$)& Exponent ($a$)  \\ \hline
Scalar-Tensor Theories &$-\frac{5}{192}\eta ^{2/5}(\alpha_1-\alpha_2)^2$&-2\\ \hline
EdGB Gravity&$-\frac{5}{192}\zeta_\EDGB\frac{(m_1^2 \tilde s_2^\EDGB-m_2^2 \tilde s_1^\EDGB)^2}{m^4\eta^{18/5}}$&-2\\ \hline
dCS Gravity&$
...
$&4\\ \hline
Einstein-\AE ther Theory& $-\frac{5}{96}\eta ^{2/5} (s_1^\EA-s_2^\EA)^2\frac{(c_{14}-2) w_0^3-w_1^3}{c_{14} w_0^3 w_1^3 [ (1-s_1^\EA) (1-s_2^\EA)]^{4/3}}$& -2\\ \hline
Khronometric Theory&$-\frac{5}{96} \eta ^{2/5}\sqrt{\bar \alpha_{\KG}}\frac{(s_1^\KG-s_2^\KG)^2}{[(1-s_1^\KG) (1-s_2^\KG)]^{4/3}} \left[\frac{(\bar \beta_{\KG}-1)(2+\bar \beta_{\KG}+3\bar \lambda_{\KG})}{(\bar \alpha_{\KG}-2)(\bar \beta_{\KG}+\bar \lambda_{\KG})}\right]^{3/2}$&-2 \\ \hline 
Noncommutative Gravity& $-\frac{3}{8}\eta ^{-4/5}(2 \eta -1) \Lambda ^2$ &4\\ \hline
Varying-G Theories& $-\frac{5\mathcal{M}_0}{512 {G_0}^{5/3}} \left(\frac{7 \dot{G}_0}{ G_0} + \frac{5\dot{m}_0}{m_0}+\frac{m_{1,0}\dot{m}_{2,0}+\dot{m}_{1,0}m_{2,0}}{{m_0}^2 \eta0}\right)$ &-8\\ 
\noalign{\smallskip}
\hline
\hline
\end{tabular}
\end{centering}
\caption{PPE corrections to GW amplitude in different various theories of gravity.}
\label{table:ppE_amp}
\end{table*}
\endgroup
}
