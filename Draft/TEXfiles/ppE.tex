...
%Varying-G theories
The formulation of PPE parameters as described above does not account for theories with a variable gravitational constant. We derive PPE parameters in such theories independently, arguing that there are two different gravitational constants entering in PPE corrections. We refer to the gravitational constant that enters in GW luminosity through the Einstein equations as dissipative gravitational constant, while the gravitational constant entering in Kepler's law is the conservative gravitational constant. %While the latter could be a function of the former, they are not necessarily same in the context of modified theories of gravity. 
The time-variation in the conservative gravitational constant leads to a variation in masses and angular momentums of compact binaries. Hence we promoted the two gravitational constants, binary masses, and their angular momentum to time-dependent forms in order to derive PPE waveforms. Our work extends the previous work of Ref.~\cite{Yunes:2009bv} where dissipative and conservative gravitational constants were considered to be the same, and also corrects an error in their energy-balance equation.
